...
var sortableEl = document.querySelectorAll('.sortable');

if (sortableEl) {
  var _iterator = _createForOfIteratorHelper(sortableEl),
      _step;
...
function reorderItems(event) {
  ...
  if (event.from.children.length > 0) {
    var _iterator2 = _createForOfIteratorHelper(event.from.children),
        _step2;
...
function _ajax() {
  _ajax = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee(url, params) {
    var response;
...
window.toggle = function () {
  return {
    ...
    toggleOnlineConsultation: function toggleOnlineConsultation(physicalIndications, onlineIndications, onlineDetailsElement, onlinePaymentDetails, otherInformation, street, city, zip, action) {
      if (action === 'off') {
