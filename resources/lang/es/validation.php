...
return [
    ...
    */
    ...
    'uuid' => 'El campo :attribute tiene que ser UUID válido.',
    ...
    */
    ...
    'attributes' => [
        ...
        'clinic_name' => __('common.clinic_name'),
        'last_name' => __('common.last_names'),
        'specialists_volume' => __('common.specialists_volume')
    ],
