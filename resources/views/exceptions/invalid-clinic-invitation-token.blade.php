...
@section('title', __('clinics.invalid_invitation'))
@section('code')
            ...
            <main class="flex-grow flex flex-col bg-white">
                <div class="flex-grow mx-auto max-w-7xl w-full flex flex-col px-4 sm:px-6 lg:px-8">
                    ...
                    <div class="flex-shrink-0 py-16 sm:py-16">
                        <h1 class="mt-2 text-4xl font-extrabold text-gray-900 tracking-tight sm:text-5xl">{{ __('clinics.invalid_invitation_title') }}</h1>
                        <p class="mt-2 text-base text-gray-500">{{ __('clinics.invalid_invitation_subtitle') }}</p>
                        <div class="mt-6">
