<x-app-layout>
    <div class="form-card">
        <div class="flex justify-between mb-2">
            <h2 class="font-bold text-xl">{{ __('common.requested_consultations') }}</h2>
        </div>
    </div>
                ...
                <table class="w-full bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
                    ...
                    @foreach($consultations as $consultation)
                        <tr class="text-gray-700 border-b dark:text-gray-400">
                            <td class="px-4 py-3 truncate">{{ $consultation->specialist->user->first_name }} {{ $consultation->specialist->user->last_name }}</td>
                            ...
                            <td class="px-4 py-3 truncate"><a class="text-xs text-white rounded bg-brand-color py-1 px-2"
                                                              href="{{ route('account.consultations.show', [
